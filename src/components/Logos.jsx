...
const Logos = () => {
  return (
    <section className="container py-5" id="Sponsors">
      <div className="pb-4">
        <h2 className="text-center mb-5">Sponsors</h2>
      </div>

      {sponsors.map((group, idx) => (
        <div className="text-center mb-5" key={idx}>
          <p className="h5 fw-semibold mb-3">{group.title}</p>
